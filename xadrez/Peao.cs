        ...
        public override bool[,] movimentosPossiveis()
        {
            ...
            if (cor == Cor.Branca)
            {
                ...
                if(posicao.linha == 3)
                {
                    ...
                    if(tab.posicaoValida(esquerda) && existeInimigo(esquerda) && tab.peca(esquerda) == partida.vulveravelEmPassant)
                    {
                        mat[esquerda.linha - 1, esquerda.coluna] = true;
                    }
                    Posicao direita = new Posicao(posicao.linha, posicao.coluna + 1);
                    if (tab.posicaoValida(direita) && existeInimigo(direita) && tab.peca(direita) == partida.vulveravelEmPassant)
                    {
